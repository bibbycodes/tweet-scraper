...
def scrape_and_update():
    ...
    for link in new_pairs_links:
        ...
        response = requests.get(link, headers=headers, proxies=px)
...
# Call the function to execute the scraping and updating
while True:
    scrape_and_update()
    print("Havin a lil snooze...")
